...
// Helper script to parse the BUF/FR2 binary formats from the prototype devices, 
// which are sent as byte streams over BLE. Another constraint given to us by our 
