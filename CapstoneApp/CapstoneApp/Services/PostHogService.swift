...
enum PostHogKeys {
    static var apiKey: String { SecretsManager.postHogAPIKey }
    static var host: String { SecretsManager.postHogHost }

    // Azure Blob Storage for media (clips/images)
    static var blobBaseURL: URL { SecretsManager.telemetryBaseURL }
    static let apiKeyHeader = "x-api-key"
    static var apiKeyValue: String { SecretsManager.telemetryAPIKey }
}
